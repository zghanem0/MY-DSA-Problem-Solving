...
- Polymorphism(poly + morphism): i can do single action in a different ways, so we can implement it either by overriding the method (overriding) or creating multiple form of the method(overloading)
