...
>> there are 2 types of sorting mechnism :
    - Comparison Sort : O(n^2) mostly except the merge-sort
        - Bubble sort : for Education
        - insertion sort: when the list is small and nearly sorted or presorted list(in general we can look at the average case if the array is nearly sorted)
...
>> what we need and use in the real life:
    - Comparison Sort:
        ...
        - Quick Sort : can sort in place, used when u care about the space complexty or couldn't put a large items in a memory and can pick a good pivot and average case matters(happened) more than the worst case
